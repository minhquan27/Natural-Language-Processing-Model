...
def diction_nag_pos_not():
    # đưa ra danh sách từ điển các từ tích cực positive, các từ tiêu cực và các từ phủ
...
def no_marks(s):
    # loại bỏ dấu câu trong tiếng Việt
